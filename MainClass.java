 ...
 * The birds will be stored in the database.
 */

public class MainClass {

    /**
     * This is the main method of the system that will run the program.
     ...
     * the program).
     * @param args Allows data to be passed through in execution.
     */
